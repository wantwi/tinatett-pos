...
const ProductMovement = () => {
  ...
  const handleGenerateReport = () => {
    ...
    const baseUrl = "report/getProductMovement";
    let filters = {
        ...
        <div className="content">
          <div className="page-header">
            <div className="page-title">
              ...
              <h6>Generate your Product Movement Report</h6>
            </div>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="table-responsive">
                <ProductMovementTable startDate={formData?.startDate} endDate={formData?.endDate} title="PRODUCT MOVEMENT REPORT" fileName="productmovementreport" data={report} />
              </div>
            </div>
          </div>
          {/* /product list */}
        ...
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Product Movement Search</h5>
              <button
                type="button"
                className="close"
