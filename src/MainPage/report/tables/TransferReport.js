...
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Toolbar, ExcelExport, PdfExport, Page, AggregateColumnsDirective, AggregateColumnDirective, AggregateDirective, AggregatesDirective, Aggregate, ColumnChooser } from '@syncfusion/ej2-react-grids';
import { image } from './image';
import { getCurrentDateInWords } from './helper';
import useAuth from '../../../hooks/useAuth';

function TransferReport({ data = [], title = "TRANSFER REPORT", fileName = "transferReport" }) {
    const { auth } = useAuth()
    console.log({ auth });
    ...
    return (<div className='control-pane'>
        <div className='control-section'>
            <div>
                <GridComponent id="Grid" pdfQueryCellInfo={pdfQueryCellInfo} showColumnChooser={true} beforePdfExport={beforePdfExport} dataSource={data} ref={grid => gridInstance = grid} pdfHeaderQueryCellInfo={pdfHeaderQueryCellInfo} toolbar={toolbarOptions} allowExcelExport={true} allowPdfExport={true} toolbarClick={toolbarClick.bind(this)} height={500} allowPaging={true} pageSettings={{ pageCount: 2, pageSize: 1000 }}>
                    <ColumnsDirective>
                        ...
                        <ColumnDirective field='branchName' headerText={`Branch`} width={180}></ColumnDirective>
                        ...
                        <ColumnDirective field='quantity' headerText='Qty' width={70}></ColumnDirective>
                        <ColumnDirective field='unitPrice' headerText='Unit Price' format='N2' width={90}></ColumnDirective>
                        <ColumnDirective field='amount' headerText='Estimate' format='N2' width={100}></ColumnDirective>
                    </ColumnsDirective>
                    <AggregatesDirective>
                        <AggregateDirective>
