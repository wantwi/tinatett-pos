...
import TransferReport from "./tables/TransferReport";
import useAuth from "../../hooks/useAuth";
import PurchaseSummary from "./tables/PurchaseSummary";
import TransferSummaryTable from "./tables/TransferSummaryTable";
...
const PurchaseOrder = () => {
  ...
  const { data: suppliers, isLoading: suppliersIsLoading } = useGet("branches", "/branch");
  ...
  useEffect(() => {
    if (!productsIsLoading && !suppliersIsLoading) {
      ...
      setSuppliersDropdown(mappedSuppliers.filter(x => x?.id !== auth?.branchId))
    }
  ...
  const handleGenerateReport = () => {
    ...
    const baseUrl = "report/getTransferSummaryReport";
    let filters = {
        ...
        <div className="content">
          <div className="page-header">
            <div className="page-title">
              <h4>Transfer Order Report</h4>
              <h6>Generate your Transfer Report</h6>
            </div>
          ...
          <div className="card">
            <div className="card-body">
              <Tabletop inputfilter={inputfilter} togglefilter={togglefilter} data={data} title={'Transfer List'} />
              {/* /Filter */}
              <div
              ...
              <div className="table-responsive">
                <TransferSummaryTable data={report} fileName="transfersummaryReport" title="TRANSFER SUMMARY REPORT" />
              </div>
            </div>
          </div>
          {/* /product list */}
        ...
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Transfer Report </h5>
              <button
                type="button"
                className="close"
