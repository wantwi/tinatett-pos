...
const CustomerList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (a, record) => (
        <>
          <Link className="me-3" to={{pathname:"/tinatett-pos/people/editcustomer", state:{...record, mode:'view'}}}>
          <span className="badges btn-cancel me-2"><FeatherIcon icon="eye" /> View</span> 
          </Link>
          <Link className="me-3" to={{pathname:"/tinatett-pos/people/editcustomer", state:{...record, mode:'edit'}}}>
